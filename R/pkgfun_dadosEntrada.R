...
#' @param horizonteprevisao Horizonte de previsao Semana Operativa ou 15 dias c("SEMOPER","15DIAS")
#' @param dataInicioPrev data de inicio da previsao
#'
#' @return Dados para entrada de modelos
#'
TransformaDeck <- function(deck,dataInicioPrev,horizonteprevisao = c("SEMOPER","15DIAS")){
   #------------------------------------------------------ -
   ...
   if(is.numeric(horizonteprevisao)) horizonteprevisao <- c("SEMOPER","15DIAS")[horizonteprevisao + 1]
   ...
   } else if(horizonteprevisao[1] == "15DIAS"){
      dataFimPrev <- dataInicioPrev + 14
