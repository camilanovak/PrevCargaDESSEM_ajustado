...
#' "15DIAS" para previsoes ate 10 dias a frente, limitado pelo horizonte da variavel exogena prevista
...
#' @export
#'
previsordessem <- function(deck,dataPrev,horizonte = c("SEMOPER","15DIAS"),modelos = obterModelos(),
